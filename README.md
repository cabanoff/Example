...
В проекте использована паттерны State, Meediator, Observer, Singleton
Этот проект реализует пользовательскую кооперативную операционную систему реального времени (RTOS) и может быть классифицирован как «кооперативный планировщик с временным триггером» с управлением задачами в стиле корутин с использованием эвентов.
Так же 
# Диаграмма классов
```mermaid
classDiagram
